...
if (c) {
  ...
  // Nota: totalPagar/totalReceber/totalFixas/totalVariaveis foram removidos
  // — eram usados apenas nos cartões de KPI do topo (Contas a Receber,
  // Contas a Pagar, Saldo Bancário, Fixas/Variáveis), removidos a pedido.
